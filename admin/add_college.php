...
?>
                                ...
                                <div class="list-group">
                                 ...
                                 if(isset($_GET['id'])) {
                                  ...
                                  ?>
                                    ...
                                    <?php $uidcollege = $row['uidCollege']?>

                                    <a href="add_course.php?id=<?php echo $uidcollege ?>"
                                        class="list-group-item list-group-item-action"><?php echo $row['college']; ?></a>
    ...
    function addCollege() {
        ...
        firebase.database().ref().child('institution').child(uid).child("college").child(uidCollege).set(data, function(
            error) {
            if (error) {
