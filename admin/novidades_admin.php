...
if($uid == null){
  if(isset($_SESSION['uidNovidade'])){
    $uid = $_SESSION['uidNovidade'];
  }else{
    header("Location: novidades_login.php");
  }
        ...
        <div class="container-fluid">
          ...
          <div class="card shadow mb-4">
            <div class="card-header py-3">
              <h6 class="m-0 font-weight-bold text-primary">Lista de Novidades</h6>
            </div>
            <div class="card-body">
